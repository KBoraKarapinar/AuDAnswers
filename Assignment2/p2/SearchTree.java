...
public interface SearchTree<T extends Comparable<T>> {
    ...
    void upgradedPredicateInOrder(Node<T> node, List<? super T> result, int max, Predicate<? super T> predicate);

    void upgradedPredicateInOrderNode(Node<T> node, List<BinaryNode<T>> result, int max, Predicate<? super T> predicate);
